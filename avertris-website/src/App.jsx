...
const T = {
  ...
  hero: {
    ...
    h1a: { en: "Your business", es: "Tu negocio" },
    h1b: { en: "deserves technology", es: "merece tecnología" },
    h1c: { en: "that keeps up", es: "a su altura" },
    ctaCases: { en: "See how we've done it", es: "Mira cómo lo hemos logrado" },
    ctaTalk: { en: "Let's talk", es: "Hablemos" },
    svc: [
      { t: { en: "Custom Software", es: "Software a Medida" }, d: { en: "Your operations are too sophisticated for off-the-shelf tools. Get platforms built around how your business actually works", es: "Tus operaciones son demasiado sofisticadas para herramientas genéricas. Obtén plataformas diseñadas para cómo tu negocio realmente funciona" } },
      { t: { en: "Growth Marketing", es: "Marketing de Crecimiento" }, d: { en: "You need a pipeline full of the right prospects — not just more traffic. Strategy that matches your ambition", es: "Necesitas un pipeline lleno de los prospectos correctos — no solo más tráfico. Estrategia a la altura de tu ambición" } },
      { t: { en: "AI Enablement", es: "Habilitación de IA" }, d: { en: "Your competitors are already exploring AI. Get ahead with integrations that deliver real ROI, not just buzzwords", es: "Tu competencia ya está explorando IA. Adelántate con integraciones que generan ROI real, no solo tendencias" } },
    ],
  },
  clients: { label: { en: "Trusted by growing companies", es: "La confianza de empresas en crecimiento" } },
  results: {
    label: { en: "What our clients experience", es: "Lo que nuestros clientes experimentan" },
    title: { en: "The outcomes you<br/>should expect", es: "Los resultados que<br/>deberías esperar" },
    stats: [
      { n: "150", s: "+", l: { en: "Projects Delivered", es: "Proyectos Entregados" }, d: { en: "For businesses that demand more than generic solutions", es: "Para negocios que exigen más que soluciones genéricas" } },
      { n: "3.2", s: "x", l: { en: "Avg. Revenue Lift", es: "Aumento Promedio de Ingresos" }, d: { en: "Because your growth targets aren't modest — and your strategy shouldn't be either", es: "Porque tus metas de crecimiento no son modestas — y tu estrategia tampoco debería serlo" } },
      { n: "40", s: "%", l: { en: "Cost Reduction", es: "Reducción de Costos" }, d: { en: "When AI is implemented with purpose, not just novelty", es: "Cuando la IA se implementa con propósito, no solo por novedad" } },
      { n: "98", s: "%", l: { en: "Client Retention", es: "Retención de Clientes" }, d: { en: "Because the best clients stay when the relationship matches their standards", es: "Porque los mejores clientes se quedan cuando la relación cumple sus estándares" } },
    ],
  },
  capabilities: {
    title: { en: "What this<br/>means for you", es: "Qué significa<br/>esto para ti" },
    cta: { en: "Let's explore what's possible", es: "Exploremos lo que es posible" },
    items: [
  ...
  whyUs: {
    label: { en: "Why it matters", es: "Por qué importa" },
    title: { en: "Built for leaders who<br/>expect more", es: "Diseñado para líderes<br/>que exigen más" },
    desc: { en: "You've outgrown agencies that only do one thing. You need software, marketing, and AI working as one strategy — because at your level, fragmented execution is a competitive risk.", es: "Ya superaste a las agencias que solo hacen una cosa. Necesitas software, marketing e IA trabajando como una sola estrategia — porque a tu nivel, la ejecución fragmentada es un riesgo competitivo." },
    cta: { en: "Let's talk", es: "Hablemos" },
    items: [
      { icon: "◉", title: { en: "One team, zero friction", es: "Un equipo, cero fricción" }, desc: { en: "You shouldn't have to coordinate between your dev agency, marketing firm, and AI consultant. One integrated team means faster decisions and better outcomes.", es: "No deberías tener que coordinar entre tu agencia de desarrollo, firma de marketing y consultor de IA. Un equipo integrado significa decisiones más rápidas y mejores resultados." } },
      { icon: "◈", title: { en: "Your reach, both markets", es: "Tu alcance, ambos mercados" }, desc: { en: "If you're scaling across US and LATAM, you need a team that doesn't just translate — they think natively in both markets.", es: "Si estás escalando en EE.UU. y LATAM, necesitas un equipo que no solo traduzca — que piense nativamente en ambos mercados." } },
      { icon: "↗", title: { en: "Premium quality, smart economics", es: "Calidad premium, economía inteligente" }, desc: { en: "Timezone-aligned, culturally fluent, and 40-50% more efficient than domestic agencies. Your budget works harder without sacrificing standards.", es: "Alineados en zona horaria, culturalmente fluidos y 40-50% más eficientes que agencias locales. Tu presupuesto rinde más sin sacrificar estándares." } },
      { icon: "◎", title: { en: "Senior people, not junior handoffs", es: "Talento senior, no delegaciones junior" }, desc: { en: "You'll work directly with the people who make strategic decisions. No account managers filtering your vision through layers.", es: "Trabajarás directamente con las personas que toman decisiones estratégicas. Sin ejecutivos de cuenta filtrando tu visión a través de capas." } },
    ],
  },
  process: {
    label: { en: "What to expect", es: "Qué esperar" },
    title: { en: "How your engagement unfolds", es: "Cómo se desarrolla tu proyecto" },
    cta: { en: "Start the conversation", es: "Inicia la conversación" },
    steps: [
      { num: "01", title: { en: "We learn your business first", es: "Primero entendemos tu negocio" }, desc: { en: "Before we propose anything, we understand your market position, growth goals, and what's actually holding you back.", es: "Antes de proponer nada, entendemos tu posición en el mercado, tus metas de crecimiento y qué te está frenando realmente." }, details: { en: ["Business & market analysis", "Technical architecture review", "Growth opportunity mapping", "AI readiness assessment"], es: ["Análisis de negocio y mercado", "Revisión de arquitectura técnica", "Mapeo de oportunidades de crecimiento", "Evaluación de preparación para IA"] } },
      { num: "02", title: { en: "We build with you, not for you", es: "Construimos contigo, no para ti" }, desc: { en: "You'll see progress weekly, have direct access to the team, and stay in control of every strategic decision.", es: "Verás progreso semanalmente, tendrás acceso directo al equipo y mantendrás el control de cada decisión estratégica." }, details: { en: ["Agile development sprints", "Campaign setup & launch", "AI model training & integration", "QA & performance testing"], es: ["Sprints de desarrollo ágil", "Configuración y lanzamiento de campañas", "Entrenamiento e integración de modelos IA", "QA y pruebas de rendimiento"] } },
      { num: "03", title: { en: "We scale what's working", es: "Escalamos lo que funciona" }, desc: { en: "Data tells us what's driving results. We double down on what works and refine the rest — because your growth shouldn't plateau.", es: "Los datos nos dicen qué impulsa resultados. Reforzamos lo que funciona y refinamos el resto — porque tu crecimiento no debería estancarse." }, details: { en: ["Performance monitoring", "A/B testing & CRO", "Iterative feature releases", "Quarterly strategy reviews"], es: ["Monitoreo de rendimiento", "Pruebas A/B y CRO", "Lanzamientos iterativos", "Revisiones estratégicas trimestrales"] } },
    ],
  },
  team: {
  ...
  cta: {
    title: { en: "Ready for the next level?", es: "¿Listo para el siguiente nivel?" },
    desc: { en: "Tell us where you want to take your business. We'll share how we'd approach it — no pitch decks, just a real conversation", es: "Cuéntanos a dónde quieres llevar tu negocio. Te compartiremos cómo lo abordaríamos — sin presentaciones, solo una conversación real" },
